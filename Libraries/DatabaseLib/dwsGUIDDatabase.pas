...
// Exec
//
procedure TdwsGUIDDataBase.Exec(const sql : String; const parameters : IScriptDynArray; context : TExprBase);
begin
...
// Query
//
function TdwsGUIDDataBase.Query(const sql : String; const parameters : IScriptDynArray; context : TExprBase) : IdwsDataSet;
var
   ds : TdwsGUIDDataSet;
begin
